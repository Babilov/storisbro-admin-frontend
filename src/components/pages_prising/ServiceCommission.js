...
export default class ServiceCommission extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      commission_withdrawal:
        localStorage.getItem("commission_withdrawal") || "",
      commission_replenishment:
        localStorage.getItem("commission_replenishment") || "",
      settings: [],
    };
  }
  ...
  handleSaveClick = () => {
    ...
    axios
      .patch(`${API_URL}api/settings_site/1`, {
  ...
  componentDidMount() {
    ...
    axios
      .get(`${API_URL}api/settings_site/1`)
      .then((response) => {
        const {
          commission_rate,
          commission_withdrawal,
          commission_replenishment,
        } = response.data; // Предполагается, что бэкенд возвращает эти значения
        this.setState({
          commission_rate:
            localStorage.getItem("commission_rate") || commission_rate,
          commission_withdrawal:
            localStorage.getItem("commission_withdrawal") ||
            commission_withdrawal,
          commission_replenishment:
                      ...
                      <Grid container justifyContent="center" mt={1}>
                        ...
                        <Grid item lg={3} md={3}>
                          <TextField
                            ...
                            onChange={
                              this.handleInputChange_commission_withdrawal
                            }
                          />
                        </Grid>
                      </Grid>
                      ...
                      <Grid container justifyContent="center" mt={1}>
                        ...
                        <Grid item lg={3} md={3}>
                          <TextField
                            ...
                            onChange={
                              this.handleInputChange_commission_replenishment
                            }
                          />
                        </Grid>
                      </Grid>
